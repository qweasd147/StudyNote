insert into article values (1, 'init subject1', 'init contents1');
insert into article values (2, 'init subject2', 'init contents2');
insert into article values (3, 'init subject3', 'init contents3');
